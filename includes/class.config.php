<?PHP
    ...
    class Config
    {
        ...
        private $productionServers = array('/thatguy\.co\.za$/');
        private $stagingServers    = array('/operations2/');
        private $localServers      = array('/^192\.168\.1\.103$/','/^192\.168\.1\.104$/','/^10\.248\.5\.113$/','/localhost/');
        ...
        private function everywhere()
        {
            ...
            $this->authSalt   = 'I am a chunky monkey from funkey town!';
        }
        ...
        private function production()
        {
            ...
            define('WEB_ROOT', '/baseline');

            $this->dbReadHost      = 'localhost';
            $this->dbWriteHost     = 'localhost';
            $this->dbName          = 'database';
            $this->dbReadUsername  = 'user';
            $this->dbWriteUsername = 'user';
            $this->dbReadPassword  = 'password';
            $this->dbWritePassword = 'password';
            $this->dbOnError       = '';
        ...
        private function staging()
        {
            ...
            define('WEB_ROOT', '/support/tools/twiz');
